...
public class MultiplicacaoDeAutomatosInterseccaoTESTE01 {
    public static void main(String[] args) {
        ...
        System.out.println("Intersecção de aut1 e aut2:");
        EnumOperador.INTERSECCAO.executaOperacao(aut1, aut2).show();
    }
}
